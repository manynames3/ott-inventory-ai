# ERP Positioning: What StockSense AI Adds Beyond SAP Or Oracle

StockSense AI is not positioned as a replacement for SAP, Oracle, or a warehouse management system. It is a focused decision layer that sits on top of ERP/WMS data and turns lot, order, inbound, and customer history into explainable daily actions.

## Short Answer

SAP and Oracle are systems of record. StockSense AI is the expiration-aware operating cockpit.

ERP systems are very good at storing transactions, enforcing master data, running purchasing processes, and controlling inventory movements. StockSense AI is designed for the planner question that often comes after the ERP has done its job:
...
Those capabilities matter. StockSense AI should not claim that SAP or Oracle cannot track expiration dates or plan replenishment.
...
StockSense AI is built for that gap.

## What StockSense AI Adds

| Buyer Need | SAP/Oracle Role | StockSense AI Role |
| --- | --- | --- |
...
> StockSense AI complements SAP and Oracle. Your ERP remains the system of record. StockSense AI sits above it as an expiration-aware decision layer that helps planners reduce waste, prevent stockouts, and explain the dollar value of each action.
...
## When StockSense AI Is A Strong Fit

StockSense AI is strongest when:
...
StockSense AI is less compelling when:
...
2. Normalize the data into StockSense AI's canonical tables.
